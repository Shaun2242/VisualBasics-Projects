Public Class cPaper
    ...
    Public Overrides Function Display() As String
        ...
        Return "Recyclable: " & "Paper" & Environment.NewLine & "Weight: " & Weight & Environment.NewLine & "Volume: " & Volume & Environment.NewLine & "Grade: " & Grade & Environment.NewLine & "Price: " & CalculateRecyclingPrice(Weight, Grade)
